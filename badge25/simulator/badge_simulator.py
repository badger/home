...
def main() -> None:
    ...
    # The archived simulator lives inside the badge25 system root.
    if args.system_root:
        ...
        # Default to the badge25 directory that contains this simulator.
        simulator_dir = os.path.dirname(os.path.abspath(__file__))
        default_root = os.path.join(simulator_dir, "..")
