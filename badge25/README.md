# Universe 2025 (Tufty) Badge Archive

This directory preserves the Universe 2025 badge source, simulator, assets,
and Badgeware API documentation. Current Universe 2026 development is in
[`../badge/`](../badge/).
...
## Table of Contents
- [Universe 2025 (Tufty) Badge Archive](#universe-2025-tufty-badge-archive)
...
**Basic usage:**
```bash
python badge25/simulator/badge_simulator.py -C badge25 badge25/apps/your_app/__init__.py
```
...
**Taking screenshots:**
```bash
python badge25/simulator/badge_simulator.py -C badge25 --screenshots ./screenshots badge25/apps/your_app/__init__.py
```
...
Shapes can also be given a transformation matrix to adjust their scale, rotation, and skew - this is very useful for creating smooth animations. [Click here for full documentation of the `Matrix` class](./badgerware/Matrix.md).
